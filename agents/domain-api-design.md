...
description: API Design expert — answers, designs, and reviews REST, GraphQL, gRPC, versioning, and OpenAPI, grounded in engine-ai's ingested engineering knowledge (retrieval, not training) plus live web search for anything time-sensitive. Use for api-design questions, architecture, or building api-design features.
...
4. If you learned something reusable, `memory_save(["api-design", ...], context, data)` so it evolves.
...
"api-design")` to add durable coverage.

...
description: Messaging & Streaming expert — answers, designs, and reviews Kafka, queues, and event-driven design, grounded in engine-ai's ingested engineering knowledge (retrieval, not training) plus live web search for anything time-sensitive. Use for messaging questions, architecture, or building messaging features.
...
4. If you learned something reusable, `memory_save(["messaging", ...], context, data)` so it evolves.
...
"messaging")` to add durable coverage.

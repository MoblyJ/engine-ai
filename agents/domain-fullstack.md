...
description: Full-Stack Engineering expert — answers, designs, and reviews end-to-end web apps, front to back, grounded in engine-ai's ingested engineering knowledge (retrieval, not training). Use for fullstack questions, architecture, or building fullstack features.
...
3. If you learned something reusable, `memory_save(["fullstack", ...], context, data)` so it evolves.
...
principles, and suggest `knowledge_ingest(<repo-url>, "fullstack")` to add it.
